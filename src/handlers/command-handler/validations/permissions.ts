import type { BuiltInValidationParams } from "types/command-handler.ts";
...
export default function ({
  ...
  if (missingUserPermissions.length) {
    ...
    embedDescription += `- You must have the ${permissionsString} ${
      getPermissionWord(
  ...
  if (missingBotPermissions.length) {
    ...
    embedDescription += `- I must have the ${permissionsString} ${
      getPermissionWord(
